 ...
 */
class DataAdapter(val dataList: List<String>, val rowLayout: Int, val context: Context) : RecyclerView.Adapter<DataAdapter.ProductViewHolder>() {
    ...
    class ProductViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        fun bind(product: String, position: Int) {
            itemView.tv_catogory.text = product
